...
namespace Rotoscope
{
    ...
    public class Frame
    {
        ...
        public void DrawLine(int x1, int y1, int x2, int y2, Color c,int w = 1)
        {
            Pen p = new Pen(c);
            p.Width = w;
        ...
        public void DrawImage(Bitmap image,Point p)
        {
            g.DrawImage(image,p);
        }

        public void RotateFrame(Bitmap image, float angle, float x, float y)
        {
